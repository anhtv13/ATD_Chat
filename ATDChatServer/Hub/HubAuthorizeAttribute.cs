...
namespace ATDChatServer
{
    ...
    /// - Authorize xem client có thể kết nối vào server hay không (hàm AuthorizeHubConnection)
    /// - Authorize xem client sau khi kết nối vào server thì có thể gọi hàm [Authorize] hay không (hàm AuthorizeHubMethodInvocation)
    /// </summary>
